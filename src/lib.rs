...
#[derive(Debug)]
pub struct LynxRaftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LynxRaftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LynxRaft processing");
    
    let mut processor = LynxRaftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LynxRaftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LynxRaftProcessor::new(false);
